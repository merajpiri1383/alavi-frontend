...
const Projects: FC<ProjectsProps> = ({ projects }) => {
    return (
        <div className="md:grid flex md:grid-cols-1 gap-4 md:h-80 overflow-scroll no-scrollbar">
            {
                projects.map((project, index) => {
                    return (
                        <div key={index} className="border group border-[#E1E1E1] p-3 md:col-span-1
                            rounded-xl hover:bg-[#292D32] transition duration-[400ms] cursor-pointer
                            min-w-48 h-fit overflow-hidden">
